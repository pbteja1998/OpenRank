    ...
    <mdb-container fluid class="custom-flex-css">
        <main-header>
            ...
            <template v-slot:others>
                ...
                <mdb-btn class="float-right" color="success" v-else style="text-transform: initial;"><mdb-icon icon="user-plus" class="mr-2" />Invite</mdb-btn>
    ...
    export default {
        ...
        methods: {
            ...
            publishTest: function () {
                ...
                this.$notify({group: 'tests', type: 'success', text: 'Test is published', duration: 3000})
            },
        },
        mounted: function () {
